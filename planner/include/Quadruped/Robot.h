 ...
 * providing methods to manipulate and retrieve information about its legs, orientation, and control
 * signals.
 */
...
class Robot {
 ...
 private:
  ...
  std::vector<double> bodyOrientation = {
      0, 0, 0}; /**< Orientation of the robot's body (roll, pitch, yaw) */
  const std::vector<double> maxTaus = {
      MAX_TAU_HIP, MAX_TAU_THIGH, MAX_TAU_CALF, MAX_TAU_HIP, MAX_TAU_THIGH, MAX_TAU_CALF,
      MAX_TAU_HIP, MAX_TAU_THIGH, MAX_TAU_CALF, MAX_TAU_HIP, MAX_TAU_THIGH, MAX_TAU_CALF,
