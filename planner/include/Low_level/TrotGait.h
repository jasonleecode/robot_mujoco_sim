...
// 前后腿 x 坐标对称（消除不对称导致的偏航漂移）
#define FR_FRONT {0.22, -0.14, -NOMINAL_HEIGHT}
#define FR_BACK {0.12, -0.14, -NOMINAL_HEIGHT}

#define FL_FRONT {0.22, 0.147, -NOMINAL_HEIGHT}
#define FL_BACK {0.12, 0.147, -NOMINAL_HEIGHT}

#define RR_FRONT {-0.14, -0.145, -NOMINAL_HEIGHT + REAR_OFFSET}
#define RR_BACK {-0.24, -0.145, -NOMINAL_HEIGHT + REAR_OFFSET}

#define RL_FRONT {-0.14, 0.145, -NOMINAL_HEIGHT + REAR_OFFSET}
#define RL_BACK {-0.24, 0.145, -NOMINAL_HEIGHT + REAR_OFFSET}
