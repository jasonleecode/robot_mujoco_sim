...
#define FR_SIDE_LEFT  {0.22, -0.11, -NOMINAL_HEIGHT}

#define FL_SIDE_RIGHT {0.22,  0.11, -NOMINAL_HEIGHT}
#define FL_SIDE_LEFT  {0.22,  0.23, -NOMINAL_HEIGHT}

#define RR_SIDE_RIGHT {-0.32, -0.23, -NOMINAL_HEIGHT + REAR_OFFSET}
#define RR_SIDE_LEFT  {-0.32, -0.11, -NOMINAL_HEIGHT + REAR_OFFSET}

#define RL_SIDE_RIGHT {-0.32,  0.11, -NOMINAL_HEIGHT + REAR_OFFSET}
#define RL_SIDE_LEFT  {-0.32,  0.23, -NOMINAL_HEIGHT + REAR_OFFSET}

#define FR_MIDDLE {0.22, -0.17, -NOMINAL_HEIGHT * 0.75}
#define FL_MIDDLE {0.22,  0.17, -NOMINAL_HEIGHT * 0.75}
#define RR_MIDDLE {-0.32, -0.17, -NOMINAL_HEIGHT * 0.75}
#define RL_MIDDLE {-0.32,  0.17, -NOMINAL_HEIGHT * 0.75}
